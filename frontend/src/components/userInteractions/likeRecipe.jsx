...
const LikeRecipe = () => {
    ...
    return (
        <p><svg onClick={handleLike} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"
            className={`w-8 h-8 text-red-600  hover:fill-red-600  hover:cursor-pointer ${likes.likes && likes.likes.includes(user && user._id) ? "fill-red-600 transition ease-in-out delay-50 hover:-translate-y-1" : "fill-none "}`}>
